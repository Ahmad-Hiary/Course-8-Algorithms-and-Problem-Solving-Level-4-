...
short GetDaysUntilEndOfMonth(strDate Date)
{
    ...
    NewDate.Day = DaysInaMonth(Date.Month, Date.Year);
...
int GetDaysUntilEndOfYear(strDate Date)
{
    strDate NewDate;
...
int main()
{
    ...
    //----------------------------
    cout << "\n\nToday is " << GetDayName(GetDayNumber(Date)) << " , ";
    PrintDate(Date);
    //----------------------------
    cout << "\n\nIs it end of week ? \n";
    if (IsEndOfWeek(Date))
    ...
    if (IsBusinessDay(Date))
        ...
        cout << "No it is not !";
    //----------------------------
    cout << "\n\nDays until end of week : " << GetDaysUntilEndOfWeek(Date);
    //----------------------------
    cout << "\n\nDays until end of Month : " << GetDaysUntilEndOfMonth(Date);
    //----------------------------
    cout << "\n\nDays until end of Year : " << GetDaysUntilEndOfYear(Date);
